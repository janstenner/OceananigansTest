...
const CORPUS_PATH = joinpath(@__DIR__, "varying_ic_corpus_Ra5e4.jld2")
const PLOT_DIRECTORY = joinpath(@__DIR__, "plots_Ra5e4")
...
used by the Ra=5e4 Varying-IC run file from noisy initial fields to time 300.
