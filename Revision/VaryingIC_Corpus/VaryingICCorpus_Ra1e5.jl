...
const CORPUS_PATH = joinpath(@__DIR__, "varying_ic_corpus_Ra1e5.jld2")
const PLOT_DIRECTORY = joinpath(@__DIR__, "plots_Ra1e5")
...
used by the Ra=1e5 Varying-IC run file from noisy initial fields to time 300.
