...
final-performance outputs each combine Fixed IC and Varying IC into a two-panel
figure with one shared horizontal legend below both panels and paper-readable
typography.
