...
#load up parameters
ps = JLD2.load("parameters.jld2", "ps_cpu")
...
if load_parameters
    lifting.weight[:,:,:,:,:] = ps.layer_1.weight[:,:,:,:,:]
    lifting.bias[:] = ps.layer_1.bias[:]

    mapping.layers[1].linear.weight[:,:,:,:,:] = ps.layer_2.layer_1.layer_1.weight[:,:,:,:,:]
    mapping.layers[1].linear.bias[:] = ps.layer_2.layer_1.layer_1.bias[:]
    mapping.layers[1].conv.weight[:,:,:] = permutedims(ps.layer_2.layer_1.layer_2.weight[:,:,:], (3,2,1))

    mapping.layers[2].linear.weight[:,:,:,:,:] = ps.layer_2.layer_2.layer_1.weight[:,:,:,:,:]
    mapping.layers[2].linear.bias[:] = ps.layer_2.layer_2.layer_1.bias[:]
    mapping.layers[2].conv.weight[:,:,:] = permutedims(ps.layer_2.layer_2.layer_2.weight[:,:,:], (3,2,1))

    mapping.layers[3].linear.weight[:,:,:,:,:] = ps.layer_2.layer_3.layer_1.weight[:,:,:,:,:]
    mapping.layers[3].linear.bias[:] = ps.layer_2.layer_3.layer_1.bias[:]
    mapping.layers[3].conv.weight[:,:,:] = permutedims(ps.layer_2.layer_3.layer_2.weight[:,:,:], (3,2,1))

    mapping.layers[4].linear.weight[:,:,:,:,:] = ps.layer_2.layer_4.layer_1.weight[:,:,:,:,:]
    mapping.layers[4].linear.bias[:] = ps.layer_2.layer_4.layer_1.bias[:]
    mapping.layers[4].conv.weight[:,:,:] = permutedims(ps.layer_2.layer_4.layer_2.weight[:,:,:], (3,2,1))

    project.layers[1].weight[:,:,:,:,:] = ps.layer_3.layer_1.weight[:,:,:,:,:]
    project.layers[1].bias[:] = ps.layer_3.layer_1.bias[:]

    project.layers[2].weight[:,:,:,:,:] = ps.layer_3.layer_2.weight[:,:,:,:,:]
    project.layers[2].bias[:] = ps.layer_3.layer_2.bias[:]
else
